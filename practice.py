...
def get_sum_zero_pairs(numbers):
    ...
    numbers = set(numbers)  # To uniquify the list
    pairs = {}
    pair = []
    sum_zero_pairs = []

    for num in numbers:
        if num > 0 and num not in pairs:
            pairs[num] = None
        elif num < 0 and -num in pairs:
            pairs[-num] = num
            pair = [-num] + [pairs[-num]]
            sum_zero_pairs.append(pair)
        elif num == 0 and num not in pairs:
            pairs[num] = 0 
            pair = [num] + [pairs[num]]
            sum_zero_pairs.append(pair)
...
def top_chars(phrase):
    ...
    # Create a dictionary to count the letter occurrences in a string 
